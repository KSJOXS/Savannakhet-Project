      ...
      <div class="nav-container">
        ...
        <div class="nav-right">
          <div
            ...
            @mouseenter="isDiscoverOpen = true"
          ...
          >
            ...
            <transition name="fade-slide">
              <div v-if="isDiscoverOpen" class="ta-dropdown-menu">
                <router-link
                  to="/explore"
                  class="ta-dropdown-item"
                  @click="isDiscoverOpen = false"
                >
                  <i class="fas fa-compass"></i>
                  {{ getTranslation("nav.exploreAll", "Explore All Places") }}
                </router-link>
                <router-link
                  to="/history"
                  class="ta-dropdown-item"
                ...
                >
                  ...
                  {{ getTranslation("nav.story", "Story of Savannakhet") }}
                </router-link>
                ...
                >
                  ...
                  {{ getTranslation("nav.smartPlanner", "Smart Trip Planner") }}
                </router-link>
              </div>
            </transition>
          </div>
          ...
          <div
            class="nav-item-dropdown"
            @mouseenter="isContributeOpen = true"
          ...
          >
            <div class="nav-item" :class="{ active: isContributeOpen }">
              ...
              <i
                class="fas fa-chevron-down dropdown-icon"
                :class="{ rotated: isContributeOpen }"
              ></i>
            </div>
            <transition name="fade-slide">
              <div v-if="isContributeOpen" class="ta-dropdown-menu">
                ...
                >
                  ...
                  {{ getTranslation("nav.writeReview", "Write Review") }}
                </router-link>
                <div class="dropdown-divider"></div>
                <router-link
                  to="/submit-place"
                ...
                >
                  ...
                  {{ getTranslation("nav.addPlace", "Add Place") }}
                </router-link>
              </div>
            </transition>
          </div>
            ...
            <transition name="fade-slide">
              <div v-if="isSupportOpen" class="ta-dropdown-menu">
                ...
                >
                  ...
                  {{ getTranslation("nav.faq", "Help & FAQ") }}
                </router-link>
                <router-link
                  to="/guide"
                  class="ta-dropdown-item"
                ...
                >
                  ...
                  {{ getTranslation("nav.userGuide", "User Guide") }}
                </router-link>
                <div class="dropdown-divider"></div>
                <router-link
                  to="/contact"
          ...
          <div class="lang-switcher">
            ...
            <transition name="fade-slide">
              <div v-if="isLangOpen" class="ta-dropdown-menu lang-menu">
                <div
                  v-for="loc in safeSupportedLocales"
                  :key="loc.code"
                  class="lang-item"
                  :class="{ active: locale === loc.code }"
                  @click.stop="switchLang(loc.code)"
                >
                  <span class="lang-flag">{{ loc.flag }}</span>
                  <span>{{ loc.label }}</span>
                  <i
                    v-if="locale === loc.code"
                    class="fas fa-check lang-check"
                  ></i>
                </div>
              </div>
            </transition>
          ...
          <div v-if="!isLoggedIn" class="auth-group">
            <router-link to="/login" class="btn-ta-ghost">{{
              getTranslation("nav.signIn", "Sign In")
            }}</router-link>
            <router-link to="/login" class="btn-ta-solid">{{
              getTranslation("nav.join", "Join")
            }}</router-link>
          </div>
            ...
            <transition name="fade-slide">
              <div v-if="isProfileOpen" class="ta-dropdown-menu profile-menu">
                ...
                >
                  ...
                  {{ getTranslation("nav.profile", "My Profile") }}
                </router-link>
                <router-link
                ...
                >
                  ...
                  {{ getTranslation("nav.myReviews", "Review History") }}
                </router-link>
                <router-link
                  to="/favorites"
                  class="ta-dropdown-item"
                ...
                >
                  ...
                  {{ getTranslation("nav.myTrips", "My Trips") }}
                </router-link>
                ...
                <div class="dropdown-divider"></div>
                <div
                  class="ta-dropdown-item logout"
                  @click="handleLogoutAndClose"
                >
                  <i class="fas fa-sign-out-alt"></i>
                  {{ getTranslation("nav.signOut", "Sign Out") }}
                </div>
              </div>
            </transition>
          </div>
      ...
      <div class="nav-container">
        <div class="sub-nav-list">
          ...
          <router-link
            to="/hotels"
            class="sub-nav-item"
            :class="{ active: route.path.includes('/hotels') }"
          >
            {{ getTranslation("nav.hotels", "Hotels") }}
          </router-link>
          <router-link
            to="/explore?tab=things-to-do"
            class="sub-nav-item"
            :class="{
              active:
                route.path === '/explore' &&
                (!route.query.tab || route.query.tab === 'things-to-do'),
            }"
          >
          ...
          <router-link
            to="/nature"
            class="sub-nav-item"
            :class="{ active: route.path.includes('/nature') }"
          >
          ...
          >
            ...
            {{ getTranslation("nav.community", "Community") }}
          </router-link>
        </div>
      </div>
    </div>
...
const switchLang = (code) => {
  ...
  try {
    ...
    else if (locale && typeof locale === "object" && "value" in locale)
      locale.value = code;
