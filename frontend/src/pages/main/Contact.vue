      ...
      <div class="contact-grid">
        <div class="contact-info">
          ...
          <p class="subtitle">
            {{
              ...
              "ไม่ว่าคุณจะมีข้อสงสัยเกี่ยวกับการใช้งานระบบแนะนำสถานที่ AI, ต้องการแจ้งปัญหา, หรือมีข้อเสนอแนะใดๆ ทีมงาน Savannakhet Smart Travel ยินดีให้บริการครับ"
            }}
          </p>
          ...
          <div class="info-cards">
            <div class="info-card">
              ...
              <div class="info-text">
                ...
                <p>
                  <a href="mailto:jo.xaysongkham99@gmail.com"
                    >jo.xaysongkham99@gmail.com</a
                  >
                </p>
              </div>
            </div>
        ...
        <div class="contact-form-card">
          ...
          <p class="form-desc">
            {{
              t("contact.formDesc") ||
              "ส่งข้อความหาเราโดยตรงผ่านฟอร์มด้านล่างนี้"
            }}
          </p>
          ...
          <form @submit.prevent="submitForm">
            <div class="form-group">
              ...
              <input
                ...
                v-model="form.name"
                required
                :placeholder="t('contact.namePlaceholder') || 'ชื่อของคุณ'"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                ...
                v-model="form.email"
                required
                :placeholder="t('contact.emailPlaceholder') || 'อีเมลของคุณ'"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                ...
                required
                :placeholder="
                  t('contact.subjectPlaceholder') || 'หัวข้อที่ต้องการติดต่อ'
                "
              />
            </div>
            ...
            <button type="submit" class="btn-submit" :disabled="isSubmitting">
              <span v-if="isSubmitting"
                ...
                {{ t("contact.sending") || "กำลังส่งข้อความ..." }}</span
              >
              <span v-else
                ><i class="fas fa-paper-plane"></i>
                {{ t("contact.sendBtn") || "ส่งข้อความ (Send Message)" }}</span
              >
            </button>
