<template>
  <div class="guide-container">
    ...
    <div class="guide-content">
      <section class="guide-section" v-for="(section, index) in guideSections" :key="index">
        <div class="section-header" @click="toggleSection(index)">
          <div class="section-title">
            <i :class="section.icon"></i>
            <h2>{{ section.title }}</h2>
          </div>
          <i class="fas fa-chevron-down" :class="{ rotated: openedSections[index] }"></i>
        </div>
        <transition name="slide-down">
          <div v-if="openedSections[index]" class="section-content">
            <p v-for="(paragraph, pIndex) in section.content" :key="pIndex" class="content-paragraph">
              {{ paragraph }}
            </p>
    ...
    return [
      {
        ...
        title: 'ใช้ตัวกรอง',
        description: 'ใช้ตัวกรองเพื่อหาสถานที่ที่ตรงกับงบประมาณและความสนใจของคุณ'
      },
      {
        icon: 'fas fa-star',
        title: 'ให้คะแนน',
  ...
  return [
    {
      icon: 'fas fa-lightbulb',
      title: 'Use Filters',
      description: 'Use filters to find places that match your budget and interests'
    },
    {
      icon: 'fas fa-star',
      title: 'Rate Places',
      description: 'Rate the places you visit so our AI can learn your preferences'
    },
    {
      icon: 'fas fa-share',
