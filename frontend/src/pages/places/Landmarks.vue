            ...
            <aside class="filter-sidebar">
                <div class="map-preview" @click="showMapModal = true">
                    ...
                    <button class="btn-view-map">
                        <i class="fas fa-map"></i> {{ t('landmarks.viewOnMap') || 'View on map' }}
                    </button>
                </div>
            ...
            <main class="landmarks-list-area">
                <div class="list-header">
                    <h2>
                        ...
                        {{ filteredLandmarks.length !== 1 ? t('landmarks.foundLabelPlural') || 'landmarks' : t('landmarks.foundLabel') || 'landmark' }} {{ t('landmarks.found') || 'found' }}
                    </h2>
                    <div class="sort-by">
                    ...
                    >
                        ...
                        <div class="card-info">
                            ...
                            <div class="description-snippet">
                                <p>{{ place.description || t('landmarks.defaultDescription') }}</p>
                            </div>
...
const handleImgError = (e) => {
    e.target.src = 'https://images.unsplash.com/photo-1544257121-628d052a1212?q=80&w=600'
}
...
.landmark-card:hover .card-img-wrapper img { transform: scale(1.06); }
...
.landmark-card:hover .place-name { color: #93c5fd; }
...
.landmark-card:hover .btn-details { color: #00aa6c; }
