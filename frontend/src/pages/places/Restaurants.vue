      ...
      <div class="header-container">
        ...
        <p class="subtitle">
          {{
            ...
            "Explore the best places to eat, drink, and relax."
          }}
        </p>
    ...
    <div class="main-layout">
      <aside class="filter-sidebar">
        ...
        <div class="filter-group">
          ...
          <label
            v-for="cat in restaurantCategories"
            :key="'sidebar-' + cat.id"
            class="filter-checkbox"
          >
            <input
      ...
      <main class="restaurant-list-area">
          ...
          <h2>
            ...
            {{
              filteredRestaurants.length !== 1
                ? t("landmarks.foundLabelPlural") || "restaurants"
                : t("landmarks.foundLabel") || "restaurant"
            }}
        ...
        <div v-else class="restaurants-grid">
          <div
            v-for="(place, index) in sortedRestaurants"
            :key="place.id"
            ...
            <div class="card-info">
              ...
              <div class="description-snippet">
                <p>
                  {{
                    place.description ||
                    "Experience the authentic flavors of Savannakhet."
                  }}
                </p>
              </div>
...
const restaurantCategories = computed(() => {
  return categories.value.filter((c) => {
    ...
    return ["restaurant", "cafe", "local_food", "chill", "nightlife"].includes(
      pType,
    );
  });
});
...
const getIconForRestaurant = (name) => {
  name = name.toLowerCase();
  if (name.includes("coffee") || name.includes("cafe") || name.includes("tea"))
  ...
  if (name.includes("bar") || name.includes("pub") || name.includes("chill"))
    return "fas fa-wine-glass-alt";
  if (name.includes("street") || name.includes("local"))
...
const getCategoryName = (id) =>
  categories.value.find((c) => c.id === id)?.name || "Restaurant";
...
.restaurant-card:hover .btn-details {
  color: #00aa6c;
}
