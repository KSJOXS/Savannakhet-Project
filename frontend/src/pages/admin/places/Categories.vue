  ...
  <div class="admin-page">
    ...
    <div class="header-content">
      <div class="title-section">
        ...
        <p class="subtitle">
          Add or remove categories for travel places in the system.
        </p>
      </div>
    </div>
      ...
      <div v-for="cat in categories" :key="cat.id" class="cat-card">
        <div class="cat-info">
          ...
          <div class="cat-details">
            ...
            <span class="parent-type-tag" :class="cat.parent_type">{{
              cat.parent_type
            }}</span>
          </div>
        </div>
...
const confirmDelete = async () => {
  ...
  try {
    ...
    if (status === 500 || status === 409) {
      showToast(
        "Cannot delete — this category has places assigned to it.",
        "error",
      );
    } else {
...
.parent-type-tag.nature {
  background: #dcfce7;
  color: #166534;
}
.parent-type-tag.restaurant {
  background: #fef9c3;
  color: #854d0e;
}
.parent-type-tag.hotel {
  background: #dbeafe;
  color: #1e40af;
}
.parent-type-tag.culture {
  background: #f3e8ff;
  color: #6b21a8;
}
.parent-type-tag.landmark {
  background: #ede9fe;
  color: #5b21b6;
}
.parent-type-tag.other {
  background: #f1f5f9;
  color: #475569;
}
