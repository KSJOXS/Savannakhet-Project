  ...
  <div class="admin-page">
    ...
    <div class="page-header">
      ...
      <div class="header-stats">
        <div class="stat-chip">
          <i class="fas fa-users"></i> {{ users.length }} Total
        </div>
        <div class="stat-chip active-chip">
          <i class="fas fa-circle dot-green"></i> {{ activeUsersCount }} Active
        </div>
      </div>
    </div>
          ...
          >
            ...
            <td>
              <span
                :class="[
                  'chip',
                  user.role === 'admin' ? 'chip-red' : 'chip-gray',
                ]"
              >
                <i
                  :class="
                    user.role === 'admin' ? 'fas fa-shield-alt' : 'fas fa-user'
                  "
                ></i>
            ...
            <td>
              <span
                v-if="user.post_permission_status === 'approved'"
                class="chip chip-green"
              >
                <i class="fas fa-check-circle"></i> Granted
              </span>
              <span
                v-else-if="user.post_permission_status === 'pending'"
    ...
    >
      <div class="modal-box danger-modal">
        ...
        <div class="modal-actions">
          <button @click="showDeleteModal = false" class="btn-ghost">
            Cancel
          </button>
    ...
    >
      <div class="modal-box">
        <div class="modal-head">
          ...
          <button @click="showEditModal = false" class="close-x">
            &times;
          </button>
        </div>
        ...
        <div class="modal-actions">
          <button @click="showEditModal = false" class="btn-ghost">
            Cancel
          </button>
...
const activeUsersCount = computed(
  () => users.value.filter((u) => !u.deleted_at).length,
);
