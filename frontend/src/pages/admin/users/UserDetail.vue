    ...
    <div class="header-content">
      <div class="title-section">
        ...
        <p class="subtitle" v-if="!loading">
          Viewing information and history for
        ...
        <div class="card profile-summary-card">
          <div class="avatar-large">
            <img
              ...
              :src="getImageUrl(userProfile.profile_image)"
              alt="avatar"
            />
          ...
          <div class="badge-container">
            ...
            <span
              class="status-badge"
              :class="{
                active: !userProfile.deleted_at,
                suspended: userProfile.deleted_at,
              }"
            >
          ...
          <div class="info-list">
            ...
            <div class="info-item">
              ...
              <span
                class="perm-status"
                :class="userProfile.post_permission_status || 'none'"
              >
                {{
      ...
      <div class="user-history-main">
        ...
        <div v-if="activeTab === 'places'" class="history-content fade-in">
          ...
          <div v-else class="list-container">
            <div v-for="place in userPlaces" :key="place.id" class="list-card">
              <img
                :src="getPlaceImage(place.image_url)"
                alt="place"
                class="list-img"
              />
              <div class="list-details">
                <div class="list-header">
                  <h4 @click="openExternal(place.id)">
                    {{ place.name }}
                    <i class="fas fa-external-link-alt small-icon"></i>
                  </h4>
                  <div class="status-actions">
                    <span class="place-status-badge" :class="place.status">{{
                      place.status
                    }}</span>
                    <button
                      v-if="place.status !== 'rejected'"
                      class="btn-action-delete"
                      @click="handleUpdatePlaceStatus(place.id, 'rejected')"
                      title="Delete Place"
                    >
                    ...
                    <button
                      ...
                      @click="handleUpdatePlaceStatus(place.id, 'approved')"
                      title="Restore Place"
                    >
        ...
        <div v-if="activeTab === 'reviews'" class="history-content fade-in">
          ...
          <div v-else class="list-container">
            ...
            >
              <img
                :src="getPlaceImage(review.place_image)"
                alt="place"
                class="list-img"
              />
              <div class="list-details">
                <div class="list-header">
                  <h4 @click="openExternal(review.place_id)">
                    {{ review.place_name }}
                    <i class="fas fa-external-link-alt small-icon"></i>
                  </h4>
                  <div class="stars">
...
const getPlaceImage = (imageString) => {
  try {
    ...
    if (imageString && !imageString.includes("["))
      return `http://127.0.0.1:8000${imageString}`;
  }
