  ...
  <div class="admin-dashboard">
    ...
    <div v-else>
      <div class="stats-grid">
        ...
        <div class="stat-card">
          <div class="stat-icon location-bg">
      ...
      <div class="dashboard-content">
        <div class="content-card">
          ...
          <div
            ...
            v-if="dashboardData.categories.length > 0"
          >
            <div
              v-for="(cat, idx) in dashboardData.categories"
              :key="idx"
              class="progress-item"
            >
              ...
              <div class="progress-bar-bg">
                <div
                  ...
                  :style="{
                    width: (cat.count / dashboardData.total_places) * 100 + '%',
                    background: '#3498db',
                  }"
                ></div>
              </div>
