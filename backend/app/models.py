...
class Place(Base):
    ...
    favorites = relationship(
        "Favorite", back_populates="place", cascade="all, delete")
    owner = relationship("User", back_populates="owned_places")
    sections = relationship("PlaceSection", back_populates="place",
                            cascade="all, delete-orphan", order_by="PlaceSection.order_index")
...
class PostComment(Base):
    ...
    post_id = Column(Integer, ForeignKey(
        "user_interactions.id", ondelete="CASCADE"))
    user_id = Column(Integer, ForeignKey("users.id"))
...
class ItineraryItem(Base):
    ...
    itinerary_id = Column(Integer, ForeignKey(
        "itineraries.id", ondelete="CASCADE"), nullable=False)
