...
sequenceDiagram
    ...
    activate "Frontend"
    "Người dùng"->>"Frontend": Nhập Username, Email, Mật khẩu, Sở thích<br/>Nhấn "Đăng ký"
    ...
    "Backend"->>"Backend": Mã hóa mật khẩu (bcrypt)<br/>Tạo tài khoản mới
    ...
    deactivate "Backend"
    "Frontend"->>"Người dùng": Thông báo thành công<br/>Chuyển đến trang đăng nhập
    deactivate "Frontend"
```
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Mở trang đăng nhập<br/>Nhập Username, Mật khẩu
    activate "Frontend"
    ...
    "Backend"->>"Backend": Kiểm tra mật khẩu (bcrypt)<br/>Tạo JWT Token
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Mở trang quên mật khẩu<br/>Nhập Email
    activate "Frontend"
    ...
    "Backend"->>"Backend": Tạo Token ngẫu nhiên<br/>Gửi Email chứa link reset
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Nhấp link từ Email<br/>Nhập Mật khẩu mới
    activate "Frontend"
    ...
    "Backend"->>"Database": Cập nhật mật khẩu<br/>Xóa Token
    activate "Database"
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Vào trang Khám phá<br/>Chọn bộ lọc (Danh mục)
    activate "Frontend"
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Nhập số ngày, ngân sách, tháng, sở thích<br/>Nhấn "Tạo kế hoạch"
    activate "Frontend"
    ...
    "Backend"->>"Backend": Phân loại Sáng/Chiều/Tối<br/>Tính Season Boost<br/>Lọc và sắp xếp
...
sequenceDiagram
    ...
    "Người dùng"->>"Frontend": Vào trang hồ sơ<br/>Nhấn "Yêu cầu quyền đăng bài"
    activate "Frontend"
...
sequenceDiagram
    ...
    "PyTorch (GNN)"->>"PyTorch (GNN)": Tính điểm Hybrid (60% GNN + 40% Content)<br/>Loại trừ địa điểm đã xem<br/>Xếp hạng Top K
...
sequenceDiagram
    ...
    activate "Backend"
    "Backend"->>"Database": Truy vấn Count(User, Place, Review)<br/>Truy vấn Chart Data
    activate "Database"
...
sequenceDiagram
    ...
    "Admin"->>"Frontend": Xem yêu cầu cấp quyền<br/>Nhấn "Phê duyệt"
    activate "Frontend"
...
sequenceDiagram
    ...
    "PyTorch (GNN)"->>"PyTorch (GNN)": Build HeteroData Graph<br/>Train 100 epochs (Negative Sampling)<br/>Tính Loss (BCE)
